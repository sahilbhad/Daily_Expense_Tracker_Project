        ...
        <ul class="nav nav-pills nav-sidebar flex-column" >
          ...
          <li class="nav-item">
            ...
            <?php 
              ...
              <?php } ?>
              <li class="nav-item">
                <a href="manneg_income.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Income</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="manneg_expense.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Expense</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="manneg_category.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Category</p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="month_report.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
